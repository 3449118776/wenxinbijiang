...
var QUANTIFIED_CONSTRAINTS = {
  ...
  innovation: {
    positive: [
      '列出本场景最热的10种套路，全部禁用后在禁区外设计方案',
      '从1-2个无关现实领域完整引用3条核心规则，转换为情节机制（禁止只堆术语）',
      '给核心场景加1-2个违反默认设定的反向限制，越具体越好',
      '反转题材默认共识，补全代价体系/日常影响/逻辑自洽链',
      '以指定现实专家身份推导事件，展现普通人看不到的行业隐性规则',
      '生成后做2-3轮反预判：列出可预判内容，提供低概率但合理的替代方案'
    ],
    negative: [
      '禁止堆砌冷门名词代替真正的剧情逻辑创新',
      '禁止为了创新违背人物动机和世界观基本逻辑',
      '创新必须对应至少一个爽点或悬念，不服务阅读体验的创新无效'
    ]
  }
};
