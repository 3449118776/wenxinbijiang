...
function buildWorldPrompt(work, userCommand, prevResult) {
  ...
  prompt += '【输出要求】\n';
  prompt += '1. 每个模块至少8000字，总字数不少于100000字\n';
...
function buildOutlinePrompt(work, userCommand, prevResult) {
  ...
  prompt += '【输出要求】\n';
  prompt += '1. 总字数不少于200000字，每卷大纲至少15000字\n';
  prompt += '2. 结构清晰，使用标题分隔\n';
...
function getGenreDetailTemplate(genre) {
  var templates = {
    ...
    '普通人战争': {
      digitalPanel: '兵力：X | 粮草：X | 士气：X | 领地：X | 声望：X | 资金：X',
      beatTypes: ['以少胜多', '计谋破敌', '战场突围', '伏击成功', '粮草逆袭', '政治博弈', '盟友背叛', '绝地翻盘', '名将崛起', '敌军溃败'],
      emotionTones: ['绝望→谋划→破局', '弱小→成长→强大', '恐惧→勇气→坚韧', '危机→转机→胜利', '牺牲→传承→崛起'],
      hookTypes: ['敌军来袭', '粮草告急', '内奸暴露', '盟友背叛', '战略转折', '敌军增援'],
      hardNodeCategories: ['军事行动', '战略谋划', '粮草管理', '情报收集', '城池攻防', '盟友交涉', '人才招募', '危机应对', '势力扩张', '战后重建']
    },
    '悬疑': {
...
function analyzeWorldviewKeywords(worldview) {
  if (!worldview || worldview.length < 10) return null;
  
  var keywordPatterns = {
    '普通人': {
      world: ['这个世界没有超能力，普通人是唯一的主角', '普通人如何在残酷的世界中生存和成长', '普通人的极限是什么，如何突破自我', '普通人的智慧和毅力是最大的武器', '平凡中见伟大，展现普通人的不平凡'],
      outline: ['规划主角从普通人到传奇人物的成长', '设计普通人面对超越自身能力的挑战', '规划普通人如何利用智慧和毅力战胜强敌', '设计多个关键时刻，普通人做出不平凡的选择'],
      chars: ['为主角设计一个"平凡"的出身，拥有普通人的烦恼', '创造一个"看似普通却蕴含巨大潜力"的主角', '设计一个"普通人逆袭"的成长弧线', '为主角设计独特的生存技巧和智慧'],
      detail: ['设计日常场景，展现普通人的生活细节', '在关键时刻展现普通人的智慧和勇气', '设计普通人面对危机时的真实反应', '在细节中展现普通人的成长和蜕变']
    },
    '极限': {
      world: ['这个世界充满挑战，每个人都在追求极限', '设计一种"突破极限"的机制，突破后获得巨大力量', '创造一种"极限"的概念，挑战人类认知', '构建一个"极限"决定一切的世界'],
      outline: ['规划主角不断突破极限的成长路径', '设计多个极限挑战，每个挑战都考验主角', '规划"极限突破"带来的后果和代价', '设计主角如何超越极限创造奇迹'],
      chars: ['为主角设计一个"永不满足"的性格，不断挑战自我', '创造一个"曾经到达过极限"的角色', '设计一个"极限"成为执念的角色', '为主角设计突破极限的独特方式'],
      detail: ['设计极限挑战场景，展现紧张刺激', '在突破极限时展现主角的心理变化', '设计极限突破后的力量展示', '在日常描写中展现对极限的追求']
    },
    '无超能力': {
      world: ['这个世界没有魔法、没有超能力，只有纯粹的人类', '设计一个"科技是唯一力量"的世界', '创造一个"纯粹靠智慧和体力"的世界', '构建一个"现实规则"主导的世界'],
      outline: ['规划主角依靠智慧和策略取得胜利', '设计多个没有超能力的战斗场景', '规划主角如何利用环境和工具', '设计普通人如何战胜强大的敌人'],
      chars: ['为主角设计一个"没有特殊能力"的设定', '创造一个"靠智慧取胜"的角色', '设计一个"身体能力普通但头脑强大"的角色', '为主角设计独特的技能和知识'],
      detail: ['设计智斗场景，展现策略和计谋', '在战斗中展现利用环境和工具', '设计没有超能力的真实战斗', '在日常描写中展现普通生活']
    },
    '现实': {
      world: ['构建一个贴近现实的世界，没有虚构元素', '设计一个"现代社会"的背景', '创造一个"真实感"极强的世界', '构建一个"现实规则"严格执行的世界'],
      outline: ['规划主角在现实世界中的奋斗', '设计多个现实生活中的挑战', '规划主角如何面对现实的残酷', '设计普通人如何在现实中成长'],
      chars: ['为主角设计一个"真实"的性格，有优点也有缺点', '创造一个"接地气"的角色', '设计一个"在现实中挣扎"的角色', '为主角设计现实的目标和追求'],
      detail: ['设计现实生活场景，展现真实细节', '在日常互动中展现真实情感', '设计现实问题的解决方式', '在细节中展现现实的残酷和温暖']
    },
    '科技': {
      world: ['构建一个"科技至上"的世界', '设计一种"高科技"的力量体系', '创造一个"科技改变一切"的世界', '构建一个"未来科技"的世界'],
      outline: ['规划主角利用科技取得优势', '设计多个科技战斗场景', '规划科技发展带来的伦理问题', '设计科技如何改变社会结构'],
      chars: ['为主角设计一个"科技天才"的设定', '创造一个"科技改造人"角色', '设计一个"科技专家"角色', '为主角设计独特的科技能力'],
      detail: ['设计科技战斗场景，展现未来科技', '在日常描写中展现科技的便利', '设计科技研发场景，展现智慧', '在细节中展现科技带来的问题']
    },
    '黑客': {
      world: ['构建一个"网络世界"与现实世界交织的世界', '设计一种"黑客技术"的力量体系', '创造一个"信息就是力量"的世界', '构建一个"网络安全"至关重要的世界'],
      outline: ['规划主角在网络世界中的冒险', '设计多个黑客对决场景', '规划网络世界与现实世界的互动', '设计黑客如何影响现实世界'],
      chars: ['为主角设计一个"顶级黑客"的设定', '创造一个"神秘黑客"角色', '设计一个"黑客组织"角色', '为主角设计独特的黑客技能'],
      detail: ['设计黑客攻击场景，展现技术魅力', '在网络世界中展现虚拟战斗', '设计黑客如何破解安全系统', '在细节中展现网络世界的危险']
    },
    '超能力': {
      world: ['构建一个"超能力者"隐藏于普通人中的世界', '设计一种"超能力"的来源和限制', '创造一个"超能力者与普通人"共存的世界', '构建一个"超能力者被追捕"的世界'],
      outline: ['规划主角发现和掌握超能力的过程', '设计多个超能力战斗场景', '规划超能力者如何隐藏身份', '设计超能力带来的社会问题'],
      chars: ['为主角设计一个"独特超能力"的设定', '创造一个"超能力者"角色', '设计一个"超能力者组织"角色', '为主角设计超能力的限制和代价'],
      detail: ['设计超能力战斗场景，展现能力多样性', '在日常描写中展现超能力的使用', '设计超能力者隐藏身份的细节', '在细节中展现超能力带来的困扰']
    },
    '异能': {
      world: ['构建一个"异能者"存在的世界', '设计一种"异能"的觉醒机制', '创造一个"异能者"被特殊管理的世界', '构建一个"异能"等级分明的世界'],
      outline: ['规划主角异能觉醒和成长的过程', '设计多个异能战斗场景', '规划异能者如何在社会中生存', '设计异能带来的权力斗争'],
      chars: ['为主角设计一个"稀有异能"的设定', '创造一个"强大异能者"角色', '设计一个"异能者组织"角色', '为主角设计异能的独特使用方式'],
      detail: ['设计异能战斗场景，展现能力特色', '在日常描写中展现异能的影响', '设计异能者之间的竞争', '在细节中展现异能带来的代价']
    },
    '重生': {
      world: ['构建一个"重生"成为可能的世界', '设计一种"重生"的规则和限制', '创造一个"重生者"拥有特殊优势的世界', '构建一个"重生"引发时空悖论的世界'],
      outline: ['规划主角重生后的逆袭之路', '设计多个重生带来的优势场景', '规划重生者如何改变命运', '设计重生带来的因果问题'],
      chars: ['为主角设计一个"重生者"的设定', '创造一个"知道未来"的角色', '设计一个"多次重生"的角色', '为主角设计重生带来的独特优势'],
      detail: ['设计重生场景，展现时空穿越', '在日常描写中展现主角预知未来', '设计主角利用重生优势改变事件', '在细节中展现重生带来的心理变化']
    },
    '穿越': {
      world: ['构建一个"穿越"成为可能的世界', '设计一种"穿越"的方式和规则', '创造一个"穿越者"改变世界的世界', '构建一个"多个世界"交织的世界'],
      outline: ['规划主角穿越后的适应和成长', '设计多个穿越带来的文化冲突', '规划穿越者如何利用现代知识', '设计穿越带来的历史改变'],
      chars: ['为主角设计一个"穿越者"的设定', '创造一个"来自不同世界"的角色', '设计一个"穿越者组织"角色', '为主角设计穿越带来的独特知识'],
      detail: ['设计穿越场景，展现时空转换', '在日常描写中展现文化差异', '设计主角利用现代知识解决问题', '在细节中展现穿越带来的思念']
    },
    '修仙': {
      world: ['构建一个"修仙"为主要力量的世界', '设计一种"修仙"的修炼体系', '创造一个"修仙者"与凡人不同的世界', '构建一个"修仙"等级分明的世界'],
      outline: ['规划主角从凡人到修仙者的成长', '设计多个修仙战斗场景', '规划修仙者如何突破境界', '设计修仙带来的长生问题'],
      chars: ['为主角设计一个"修仙天赋"的设定', '创造一个"强大修仙者"角色', '设计一个"修仙门派"角色', '为主角设计独特的修仙之路'],
      detail: ['设计修仙修炼场景，展现灵气运用', '在战斗中展现法术和法宝', '设计突破境界的场景', '在日常描写中展现修仙者的生活']
    },
    '魔法': {
      world: ['构建一个"魔法"为主要力量的世界', '设计一种"魔法"的使用规则', '创造一个"魔法师"地位崇高的世界', '构建一个"魔法"元素丰富的世界'],
      outline: ['规划主角学习和掌握魔法的过程', '设计多个魔法战斗场景', '规划魔法师如何提升等级', '设计魔法带来的社会问题'],
      chars: ['为主角设计一个"魔法天赋"的设定', '创造一个"强大魔法师"角色', '设计一个"魔法学院"角色', '为主角设计独特的魔法属性'],
      detail: ['设计魔法战斗场景，展现魔法绚丽', '在日常描写中展现魔法的使用', '设计魔法学习场景，展现智慧', '在细节中展现魔法带来的代价']
    },
    '丧尸': {
      world: ['构建一个"丧尸病毒爆发"后的世界', '设计一种"丧尸"的变异机制', '创造一个"幸存者"挣扎求生的世界', '构建一个"丧尸"威胁不断升级的世界'],
      outline: ['规划主角在丧尸世界中的生存', '设计多个丧尸战斗场景', '规划幸存者如何建立安全区', '设计丧尸进化带来的挑战'],
      chars: ['为主角设计一个"生存专家"的设定', '创造一个"冷酷幸存者"角色', '设计一个"科学家"角色', '为主角设计独特的生存技巧'],
      detail: ['设计丧尸战斗场景，展现紧张刺激', '在日常描写中展现生存的艰辛', '设计物资搜寻场景，展现策略', '在细节中展现人性的考验']
    },
    '末世': {
      world: ['构建一个"文明崩溃"后的世界', '设计一种"末世"的原因和状态', '创造一个"幸存者"重建文明的世界', '构建一个"末世"危险丛生的世界'],
      outline: ['规划主角在末世中的生存和发展', '设计多个末世危机场景', '规划幸存者如何建立新秩序', '设计末世带来的人性考验'],
      chars: ['为主角设计一个"领导者"的设定', '创造一个"坚强幸存者"角色', '设计一个"理想主义者"角色', '为主角设计独特的领导能力'],
      detail: ['设计末世生存场景，展现残酷现实', '在日常描写中展现幸存者的生活', '设计团队合作场景，展现信任', '在细节中展现希望的光芒']
    },
    '星际': {
      world: ['构建一个"星际文明"时代的世界', '设计一种"星际旅行"的技术', '创造一个"多个星球"共存的世界', '构建一个"星际战争"的世界'],
      outline: ['规划主角在星际间的冒险', '设计多个星际战斗场景', '规划星际文明的碰撞', '设计主角如何探索未知星球'],
      chars: ['为主角设计一个"星际探险家"的设定', '创造一个"外星盟友"角色', '设计一个"星际舰队"角色', '为主角设计独特的星际技能'],
      detail: ['设计星际战斗场景，展现太空战', '在日常描写中展现星际旅行', '设计外星探索场景，展现新奇', '在细节中展现宇宙的浩瀚']
    },
    '机甲': {
      world: ['构建一个"机甲"为主要武器的世界', '设计一种"机甲"的驾驶和战斗系统', '创造一个"机甲驾驶员"地位崇高的世界', '构建一个"机甲"技术发达的世界'],
      outline: ['规划主角成为顶级机甲驾驶员的过程', '设计多个机甲战斗场景', '规划机甲驾驶员的成长和挑战', '设计机甲技术带来的战争'],
      chars: ['为主角设计一个"机甲天才"的设定', '创造一个"王牌机甲驾驶员"角色', '设计一个"机甲制造商"角色', '为主角设计独特的机甲风格'],
      detail: ['设计机甲战斗场景，展现机械美学', '在日常描写中展现机甲维护', '设计机甲驾驶场景，展现技巧', '在细节中展现机甲带来的代价']
    },
    '校园': {
      world: ['构建一个"校园"为主要舞台的世界', '设计一种"校园生活"的特殊规则', '创造一个"学生"拥有特殊能力的世界', '构建一个"校园"充满秘密的世界'],
      outline: ['规划主角在校园中的成长和冒险', '设计多个校园事件', '规划校园中的友情和爱情', '设计校园秘密的揭开'],
      chars: ['为主角设计一个"学生"的身份', '创造一个"校园名人"角色', '设计一个"神秘学生"角色', '为主角设计独特的校园生活'],
      detail: ['设计校园日常场景，展现青春活力', '在日常描写中展现学生生活', '设计校园事件场景，展现冲突', '在细节中展现青春的美好']
    },
    '恋爱': {
      world: ['构建一个"爱情"为主线的世界', '设计一种"浪漫"的氛围', '创造一个"爱情故事"精彩的世界', '构建一个"恋爱"充满挑战的世界'],
      outline: ['规划主角的恋爱历程', '设计多个浪漫场景', '规划恋爱中的矛盾和成长', '设计爱情带来的改变'],
      chars: ['为主角设计一个"渴望爱情"的性格', '创造一个"完美恋人"角色', '设计一个"情敌"角色', '为主角设计独特的恋爱方式'],
      detail: ['设计浪漫场景，展现甜蜜互动', '在日常描写中展现感情升温', '设计恋爱矛盾场景，展现考验', '在细节中展现爱情的美好']
    },
    '恐怖': {
      world: ['构建一个"恐怖"元素充斥的世界', '设计一种"恐怖"的来源和规则', '创造一个"恐怖事件"频发的世界', '构建一个"恐怖"与现实交织的世界'],
      outline: ['规划主角面对恐怖的勇气', '设计多个恐怖场景', '规划主角如何揭开恐怖真相', '设计恐怖带来的心理变化'],
      chars: ['为主角设计一个"勇敢"的性格', '创造一个"经历过恐怖"的角色', '设计一个"神秘人物"角色', '为主角设计独特的对抗恐怖的方式'],
      detail: ['设计恐怖场景，展现惊悚氛围', '在日常描写中展现恐怖元素', '设计主角面对恐怖的反应', '在细节中展现恐怖背后的真相']
    },
    '悬疑': {
      world: ['构建一个"悬疑"事件频发的世界', '设计一种"谜团"的设计方式', '创造一个"真相"难寻的世界', '构建一个"悬疑"与阴谋交织的世界'],
      outline: ['规划主角解开谜团的过程', '设计多个悬疑事件', '规划主角如何寻找线索', '设计真相揭露的震撼'],
      chars: ['为主角设计一个"侦探"的身份', '创造一个"神秘人物"角色', '设计一个"嫌疑人"角色', '为主角设计独特的推理能力'],
      detail: ['设计推理场景，展现逻辑思维', '在日常描写中展现线索收集', '设计悬疑事件场景，展现紧张', '在细节中展现真相的逐步揭开']
    },
    '战争': {
      world: ['构建一个"战争"连绵的世界', '设计一种"战争"的规则和策略', '创造一个"战士"生存的世界', '构建一个"战争"改变一切的世界'],
      outline: ['规划主角在战争中的成长', '设计多个战争场景', '规划战争带来的改变和牺牲', '设计战争结束后的和平'],
      chars: ['为主角设计一个"战士"的身份', '创造一个"指挥官"角色', '设计一个"和平主义者"角色', '为主角设计独特的战斗风格'],
      detail: ['设计战争场景，展现残酷现实', '在日常描写中展现军营生活', '设计战斗场景，展现勇气', '在细节中展现战争带来的伤痛']
    },
    '历史': {
      world: ['构建一个"历史"为背景的世界', '设计一种"历史"的细节和真实感', '创造一个"历史人物"活跃的世界', '构建一个"历史"可以改变的世界'],
      outline: ['规划主角在历史中的影响', '设计多个历史事件', '规划主角如何改变历史', '设计历史带来的命运'],
      chars: ['为主角设计一个"历史人物"的身份', '创造一个"历史名人"角色', '设计一个"历史研究者"角色', '为主角设计独特的历史知识'],
      detail: ['设计历史场景，展现时代风貌', '在日常描写中展现历史细节', '设计历史事件场景，展现壮阔', '在细节中展现历史人物的情感']
    },
    '江湖': {
      world: ['构建一个"江湖"为舞台的世界', '设计一种"江湖"的规矩和义气', '创造一个"侠客"横行的世界', '构建一个"江湖"恩怨情仇的世界'],
      outline: ['规划主角在江湖中的成名之路', '设计多个江湖事件', '规划主角如何处理恩怨情仇', '设计江湖带来的成长'],
      chars: ['为主角设计一个"侠客"的身份', '创造一个"江湖大佬"角色', '设计一个"神秘侠客"角色', '为主角设计独特的武功风格'],
      detail: ['设计江湖打斗场景，展现武侠魅力', '在日常描写中展现江湖规矩', '设计侠客互动场景，展现义气', '在细节中展现江湖儿女的情感']
    },
    '宫廷': {
      world: ['构建一个"宫廷"为舞台的世界', '设计一种"宫廷"的规矩和斗争', '创造一个"皇权"至上的世界', '构建一个"宫廷"阴谋丛生的世界'],
      outline: ['规划主角在宫廷中的生存和斗争', '设计多个宫廷事件', '规划主角如何获得权力', '设计宫廷带来的命运'],
      chars: ['为主角设计一个"宫廷人物"的身份', '创造一个"皇帝"角色', '设计一个"权臣"角色', '为主角设计独特的权谋手段'],
      detail: ['设计宫廷场景，展现华丽与残酷', '在日常描写中展现宫廷规矩', '设计权谋斗争场景，展现智慧', '在细节中展现宫廷人物的情感']
    },
    '商战': {
      world: ['构建一个"商业"为舞台的世界', '设计一种"商业"的规则和竞争', '创造一个"商人"崛起的世界', '构建一个"商业"改变一切的世界'],
      outline: ['规划主角在商业中的崛起', '设计多个商战场景', '规划主角如何击败对手', '设计商业带来的财富和地位'],
      chars: ['为主角设计一个"商人"的身份', '创造一个"商业巨头"角色', '设计一个"商业对手"角色', '为主角设计独特的商业眼光'],
      detail: ['设计商战场景，展现商业智慧', '在日常描写中展现商业运作', '设计商业谈判场景，展现策略', '在细节中展现商人的情感']
    },
    '体育': {
      world: ['构建一个"体育"为舞台的世界', '设计一种"体育"的规则和竞争', '创造一个"运动员"拼搏的世界', '构建一个"体育"改变命运的世界'],
      outline: ['规划主角在体育中的成长', '设计多个比赛场景', '规划主角如何成为冠军', '设计体育带来的荣耀和伤痛'],
      chars: ['为主角设计一个"运动员"的身份', '创造一个"体育明星"角色', '设计一个"教练"角色', '为主角设计独特的运动天赋'],
      detail: ['设计比赛场景，展现体育魅力', '在日常描写中展现训练生活', '设计关键时刻的逆转', '在细节中展现运动员的情感']
    },
    '游戏': {
      world: ['构建一个"游戏"为主题的世界', '设计一种"游戏"的规则和奖励', '创造一个"游戏玩家"活跃的世界', '构建一个"游戏"与现实交织的世界'],
      outline: ['规划主角在游戏中的成长', '设计多个游戏场景', '规划主角如何成为游戏高手', '设计游戏带来的改变'],
      chars: ['为主角设计一个"游戏玩家"的身份', '创造一个"游戏大神"角色', '设计一个"游戏NPC"角色', '为主角设计独特的游戏技巧'],
      detail: ['设计游戏场景，展现虚拟世界', '在日常描写中展现游戏生活', '设计游戏战斗场景，展现技巧', '在细节中展现游戏玩家的情感']
    },
    '虚拟现实': {
      world: ['构建一个"虚拟现实"发达的世界', '设计一种"VR"的规则和体验', '创造一个"VR世界"与现实交织的世界', '构建一个"VR"改变生活的世界'],
      outline: ['规划主角在VR世界中的冒险', '设计多个VR场景', '规划VR世界与现实世界的互动', '设计VR带来的问题和机遇'],
      chars: ['为主角设计一个"VR玩家"的身份', '创造一个"VR开发者"角色', '设计一个"VR世界角色"', '为主角设计独特的VR技巧'],
      detail: ['设计VR场景，展现虚拟体验', '在日常描写中展现VR生活', '设计VR战斗场景，展现刺激', '在细节中展现VR带来的影响']
    },
    '赛博朋克': {
      world: ['构建一个"赛博朋克"风格的世界', '设计一种"高科技低生活"的社会', '创造一个"义体改造"普遍的世界', '构建一个"巨型企业"统治的世界'],
      outline: ['规划主角在赛博朋克世界中的生存', '设计多个赛博朋克场景', '规划主角如何对抗巨型企业', '设计赛博朋克带来的人性问题'],
      chars: ['为主角设计一个"义体改造人"的身份', '创造一个"黑客"角色', '设计一个"企业高管"角色', '为主角设计独特的赛博朋克风格'],
      detail: ['设计赛博朋克场景，展现未来都市', '在日常描写中展现义体生活', '设计黑客攻击场景，展现技术', '在细节中展现赛博朋克的黑暗']
    },
    '蒸汽朋克': {
      world: ['构建一个"蒸汽朋克"风格的世界', '设计一种"蒸汽科技"的力量体系', '创造一个"维多利亚时代"与科技结合的世界', '构建一个"蒸汽机械"发达的世界'],
      outline: ['规划主角在蒸汽朋克世界中的冒险', '设计多个蒸汽朋克场景', '规划主角如何利用蒸汽科技', '设计蒸汽朋克带来的社会变革'],
      chars: ['为主角设计一个"发明家"的身份', '创造一个"蒸汽机械师"角色', '设计一个"贵族"角色', '为主角设计独特的蒸汽科技能力'],
      detail: ['设计蒸汽朋克场景，展现机械美学', '在日常描写中展现蒸汽生活', '设计机械战斗场景，展现力量', '在细节中展现蒸汽朋克的浪漫']
    },
    '克苏鲁': {
      world: ['构建一个"克苏鲁"风格的世界', '设计一种"不可知恐怖"的氛围', '创造一个"古神"存在的世界', '构建一个"理智"受到考验的世界'],
      outline: ['规划主角面对克苏鲁恐怖的经历', '设计多个恐怖场景', '规划主角如何保持理智', '设计克苏鲁带来的真相'],
      chars: ['为主角设计一个"调查员"的身份', '创造一个"疯狂者"角色', '设计一个"古神信徒"角色', '为主角设计独特的理智值机制'],
      detail: ['设计克苏鲁场景，展现恐怖氛围', '在日常描写中展现理智状态', '设计恐怖遭遇场景，展现惊悚', '在细节中展现古神的恐怖']
    },
    '神话': {
      world: ['构建一个"神话"为背景的世界', '设计一种"神话生物"存在的世界', '创造一个"神祇"活跃的世界', '构建一个"神话"与现实交织的世界'],
      outline: ['规划主角在神话世界中的冒险', '设计多个神话场景', '规划主角如何与神祇互动', '设计神话带来的命运'],
      chars: ['为主角设计一个"神话人物"的身份', '创造一个"神祇"角色', '设计一个"神话生物"角色', '为主角设计独特的神话能力'],
      detail: ['设计神话场景，展现神话世界', '在日常描写中展现神话元素', '设计神祇互动场景，展现神圣', '在细节中展现神话人物的情感']
    },
    '妖怪': {
      world: ['构建一个"妖怪"存在的世界', '设计一种"妖怪"的种类和规则', '创造一个"人与妖怪"共存的世界', '构建一个"妖怪"与人类对立的世界'],
      outline: ['规划主角与妖怪的互动', '设计多个妖怪场景', '规划主角如何处理人与妖怪的关系', '设计妖怪带来的冲突'],
      chars: ['为主角设计一个"除妖师"的身份', '创造一个"妖怪"角色', '设计一个"半妖"角色', '为主角设计独特的除妖能力'],
      detail: ['设计妖怪场景，展现妖怪世界', '在日常描写中展现妖怪元素', '设计除妖场景，展现战斗', '在细节中展现人与妖怪的情感']
    },
    '吸血鬼': {
      world: ['构建一个"吸血鬼"存在的世界', '设计一种"吸血鬼"的规则和弱点', '创造一个"吸血鬼"隐藏于人类中的世界', '构建一个"吸血鬼"与猎人对立的世界'],
      outline: ['规划主角与吸血鬼的互动', '设计多个吸血鬼场景', '规划主角如何成为吸血鬼猎人', '设计吸血鬼带来的秘密'],
      chars: ['为主角设计一个"吸血鬼猎人"的身份', '创造一个"吸血鬼"角色', '设计一个"吸血鬼始祖"角色', '为主角设计独特的猎魔能力'],
      detail: ['设计吸血鬼场景，展现黑暗氛围', '在日常描写中展现吸血鬼生活', '设计猎魔场景，展现战斗', '在细节中展现吸血鬼的情感']
    },
    '狼人': {
      world: ['构建一个"狼人"存在的世界', '设计一种"狼人"的变身规则', '创造一个"狼人"隐藏于人类中的世界', '构建一个"狼人"族群斗争的世界'],
      outline: ['规划主角成为狼人的过程', '设计多个狼人场景', '规划主角如何控制变身', '设计狼人带来的命运'],
      chars: ['为主角设计一个"狼人"的身份', '创造一个"狼人领袖"角色', '设计一个"狼人猎人"角色', '为主角设计独特的狼人能力'],
      detail: ['设计狼人场景，展现野性力量', '在日常描写中展现狼人生活', '设计变身场景，展现痛苦与力量', '在细节中展现狼人的情感']
    }
  };
  ...
  for (var k in keywordPatterns) {
    if (worldview.indexOf(k) >= 0) {
      matchedKeywords.push(k);
      result[k] = keywordPatterns[k];
    }
  }
...
function getGenreCreativePrompts(genre) {
  var prompts = {
    ...
    '普通人战争': {
      world: ['构建一个没有超自然力量的中世纪战争世界', '设计一种纯粹依靠智谋和策略的战争体系', '创造一个普通人也能成为英雄的时代', '构建一个资源稀缺、势力纷争的乱世格局', '设计一个靠训练和经验提升实力的力量体系', '创造一个战争与阴谋交织的政治格局'],
      outline: ['规划主角从普通士兵到名将的成长', '设计多个真实的战争场景，没有超能力', '规划主角利用智谋和策略取得胜利', '设计主角如何在权力斗争中生存', '规划普通人如何改变历史进程', '设计战争带来的人性考验和成长'],
      chars: ['为主角设计一个"普通人"的出身，没有特殊能力', '创造一个靠智谋取胜的角色', '设计一个真实的战士形象，有恐惧也有勇气', '创造一个政治谋略家角色，擅长算计', '为主角设计独特的战术思维和指挥能力', '创造一个有血有肉的反派，动机真实可信'],
      detail: ['设计真实的战斗场景，没有魔法和超能力', '在日常描写中展现士兵的生活和情感', '设计战术谋划场景，展现智慧', '在战斗中展现团队协作和指挥能力', '设计政治斗争场景，展现权谋', '在细节中展现战争的残酷和人性']
    }
  };
